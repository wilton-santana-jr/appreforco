...
<div class="fieldcontain ${hasErrors(bean: aulaInstance, field: 'usuarioProfessor', 'error')} required">
	<label for="usuarioProfessor">
		<g:message code="aula.usuarioProfessor.label" default="Usuario Professor" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="usuarioProfessor" name="usuarioProfessor.id" from="${com.yourapp.User.list()}" optionKey="id" required="" value="${aulaInstance?.usuarioProfessor?.id}" class="many-to-one"/>

</div>

<div class="fieldcontain ${hasErrors(bean: aulaInstance, field: 'categoria', 'error')} required">
	<label for="categoria">
		<g:message code="aula.categoria.label" default="Categoria" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="categoria" name="categoria.id" from="${com.yourapp.Categoria.list()}" optionKey="id" required="" value="${aulaInstance?.categoria?.id}" class="many-to-one"/>
